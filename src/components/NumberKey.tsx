...
const NumberKey = ({ keyNumber, handleInputNumber }: Props) => {
  return (
    ...
    >
      <p className="w-14 h-14 rounded-2xl border-4 border-black bg-white text-4xl text-black font-bold flex justify-center items-center active:scale-90 active:bg-gray-500 cursor-pointer animate-pulse animate-infinite">
        {keyNumber}
      </p>
    </button>
  );
